          ...
          <div className="flex justify-between">
            ...
            <div className="w-full md:w-1/3 p-6">
              ...
              <p className="text-gray-700 mb-1">
                Agricultor:{" "}
                <span className="font-semibold">{productDetails.farmer}</span>
              </p>
              <p className="text-gray-700 mb-1">
                Finca:{" "}
                <span className="font-semibold">{productDetails.farm}</span>
              </p>
              <p className="text-gray-700 mb-1">
                Fecha de cosecha:{" "}
              ...
              <p className="text-gray-700 mb-1">
                Estado:{" "}
                <span className="font-semibold">{productDetails.status}</span>
              </p>
              <p className="text-gray-700 mb-4">
                Contacto:{" "}
                <span className="font-semibold">{productDetails.contact}</span>
              </p>
            </div>
